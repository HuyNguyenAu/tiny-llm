...
public class BPETokeniserTests()
{
    ...
    [Fact]
    public void IsPairInMintedTokens_HasMintedToken_ReturnsTrue()
    {
        // Arrange.
        var pair = new Tuple<int, int>(89, 97);
        var mintedTokens = new Dictionary<int, Tuple<int, int>>
        {
            { 90, pair },
            { 89, new Tuple<int, int>(97, 98) },
            { 88, new Tuple<int, int>(98, 100) },
        };

        // Act.
        var result = BPETokeniser.IsPairInMintedTokens(pair, mintedTokens);
    ...
    [Fact]
    public void IsPairInMintedTokens_MissingMintedToken_ReturnsFalse()
    {
        // Arrange.
        var pair = new Tuple<int, int>(97, 97);
        var mintedTokens = new Dictionary<int, Tuple<int, int>>
        {
            { 89, new Tuple<int, int>(97, 98) },
            { 88, new Tuple<int, int>(98, 100) },
    ...
    [Fact]
    public void IsAllPairFrequenciesOne_HasPairFrequencyOne_ReturnTrue()
    {
        // Arrange.
        var pairFrequencies = new List<KeyValuePair<Tuple<int, int>, int>>
        {
            new(new Tuple<int, int>(97, 97), 1),
            new(new Tuple<int, int>(97, 98), 1),
            new(new Tuple<int, int>(98, 100), 1),
            new(new Tuple<int, int>(100, 97), 1),
            new(new Tuple<int, int>(98, 97), 1),
            new(new Tuple<int, int>(97, 99), 1),
        ...
        // Act.
        var result = BPETokeniser.IsAllPairFrequenciesOne(pairFrequencies);
    ...
    [Fact]
    public void IsAllPairFrequenciesOne_HasPairFrequencyGreaterThanOne_ReturnsFalse()
    {
        // Arrange.
        var pairFrequencies = new List<KeyValuePair<Tuple<int, int>, int>>
        {
    ...
    [Fact]
    public void ShouldRecursivelyEncode_HasNonMintedTokensOne_ReturnsTrue()
    {
        // Arrange.
        var pairFrequencies = new List<KeyValuePair<Tuple<int, int>, int>>
        {
            new(new Tuple<int, int>(90, 98), 2),
            new(new Tuple<int, int>(97, 97), 1),
            new(new Tuple<int, int>(98, 100), 1),
        };
        var mintedTokens = new Dictionary<int, Tuple<int, int>>
        {
            { 90, new Tuple<int, int>(97, 97) },
        };

        // Act.
        var result = BPETokeniser.ShouldRecursivelyEncode(pairFrequencies, mintedTokens);
    ...
    [Fact]
    public void ShouldRecursivelyEncode_HasNonMintedTokensOne_ReturnsFalse()
    {
       // Arrange.
        var pairFrequencies = new List<KeyValuePair<Tuple<int, int>, int>>
        {
            new(new Tuple<int, int>(90, 98), 2),
            new(new Tuple<int, int>(97, 97), 2),
            new(new Tuple<int, int>(98, 100), 1),
        };
        var mintedTokens = new Dictionary<int, Tuple<int, int>>
        {
